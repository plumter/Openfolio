...
const QrCodeTab = _ => {
    ...
    return  <div>
                <div className="py-10 my-10 rounded-3xl border">
                    <img 
                ...
                <div className="my-5 rounded-3xl border">
                    <h5
                        className="font-medium p-5 border-b text-base"
                    >
                        Color
                    </h5>
                    <div 
                    ...
                    >
                        {
                            ["black", "white"].map(item => <label
                                                                key={item}
                                                                className={`flex border rounded-full py-3.5 pl-5 cursor-pointer ${item === qrColor && "border-primary text-black-1"}`}
                                                            >
                                                                <span 
